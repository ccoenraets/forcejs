...
var query = function query() {
    ...
    // Retrieve contacts
    force.query('select id, firstName, lastName from contact LIMIT 50').then(function (response) {
        var str = '';
...
function create() {
    force.create('contact', { FirstName: firstNameField.value, LastName: lastNameField.value }).then(function (response) {
        console.log(response);
    })['catch'](errorHandler);
}

function update() {
    force.update('contact', { Id: idField.value, FirstName: firstNameField.value, LastName: lastNameField.value }).then(function (response) {
        console.log(response);
    })['catch'](errorHandler);
}

function del() {
    force.del('contact', idField.value).then(function (response) {
        console.log(response);
    })['catch'](errorHandler);
}

function retrieve(id) {
    force.retrieve('contact', id, null).then(function (contact) {
        console.log(contact);
...
},{"./force":2}],2:[function(require,module,exports){
/**
 ...
 * @param pathOrParams
 */
var chatter = function chatter(params) {
